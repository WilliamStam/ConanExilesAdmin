...
$(document).ready(function () {
	...
	$(document).on("submit", "#form", function (e) {
		...
		$.post("/app/save/settings_users/form?ID=" + ID, data, function (result) {
			result = result.data;
...
function getForm() {
	...
	$.getData("/app/data/settings_users/form", {"ID": ID}, function (data) {
...
function getList() {
	...
	$.getData("/app/data/settings_users/_list", {"ID": ID, "search": search}, function (data) {
